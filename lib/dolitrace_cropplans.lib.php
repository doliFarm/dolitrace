...
/**
 * \file    dolitrace/lib/dolitrace_cropplans.lib.php
 * \ingroup dolitrace
 * \brief   Library files with common functions for Cropplans
 */

/**
 * Prepare array of tabs for MyObject
 *
 * @param	Cropplans	$object		Cropplans
 * @return 	array					Array of tabs
 */
function cropplansPrepareHead($object)
{
	...
	$head[$h][0] = dol_buildpath("/dolitrace/cropplans_agenda.php", 1).'?id='.$object->id;
	...
	//	'entity:-tabname:Title:@dolitrace:/dolitrace/mypage.php?id=__ID__'
	//); // to remove a tab
	complete_head_from_modules($conf, $langs, $object, $head, $h, 'cropplans@dolitrace');

	complete_head_from_modules($conf, $langs, $object, $head, $h, 'cropplans@dolitrace', 'remove');
