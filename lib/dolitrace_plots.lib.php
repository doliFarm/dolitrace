...
/**
 * \file    dolitrace/lib/dolitrace_plots.lib.php
 * \ingroup dolitrace
 * \brief   Library files with common functions for Plots
 */

/**
 * Prepare array of tabs for Plots
 *
...
function plotsPrepareHead($object)
{
	...
	$head[$h][0] = dol_buildpath("/dolitrace/plots_card.php", 1).'?id='.$object->id;
	...
	if (isset($object->fields['note_public']) || isset($object->fields['note_private'])) {
		...
		$head[$h][0] = dol_buildpath('/dolitrace/plots_note.php', 1).'?id='.$object->id;
	...
	$head[$h][0] = dol_buildpath("/dolitrace/plots_document.php", 1).'?id='.$object->id;
	...
	$head[$h][0] = dol_buildpath("/dolitrace/plots_agenda.php", 1).'?id='.$object->id;
